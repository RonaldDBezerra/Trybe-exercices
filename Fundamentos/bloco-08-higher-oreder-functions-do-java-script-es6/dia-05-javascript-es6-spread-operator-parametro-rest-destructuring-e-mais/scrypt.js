...
const sum = (...value) => {
    let resultado = value.reduce((acumulador, elemento) => {
...
const resultado = `${name} is ${age} years old and likes ${likes.join(', ')}.`
...
const resultado = param.filter(elemento => {
...
const swap = ([numero1, numero2, numero3]) => [numero3, numero2, numero1];
